...
$routes->group('testing', ['namespace' => 'App\Controllers'], function ($routes) {
	$routes->get('/', 'testing::index');
});

$routes->get('/', 'AuthController::login', ['as' => 'default_login']);
...
$routes->group('admin', ['namespace' => 'App\Controllers'], function ($routes) {
	...
	*/
	...
	// For register user
	$routes->get('users/register', 'Admin::register', ['filter' => 'permission:1']);
	$routes->post('users/register', 'Admin::attemptRegister', ['filter' => 'permission:1']);
